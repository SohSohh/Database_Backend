document.addEventListener('DOMContentLoaded', function() {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjo0ODk5OTA2NDAxLCJpYXQiOjE3NDYzMDY0MDEsImp0aSI6ImNjZmEzZTFiMmU2YTRjZmU4YzU4M2FiYjAwYmNmMjcwIiwidXNlcl9pZCI6OX0.uolpG4ckeSk3iwSWG_GmxJShZ6tU5Eufgc1sEqmwe9c";
    ...
    function displayEventDetails(event) {
        ...
        document.getElementById('event-rating').textContent = event.average_rating ? `${event.average_rating.toFixed(1)} / 5` : 'N/A';
    ...
    function setupCommentForm() {
        ...
        commentForm.addEventListener('submit', function(e) {
            ...
            if (selectedRating) {
                commentData.rating = parseInt(selectedRating.value);
            }
