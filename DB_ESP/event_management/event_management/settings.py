...
SECRET_KEY = 'django-insecure-8rhots@ggxzb9yp0$gxlzv&$y3utxlnsm54en9n+@2d88z84xj'
...
LOGGING = {
    ...
    'loggers': {
        ...
        '__main__': {  # for custom middleware logging
            'handlers': ['console'],
            'level': 'DEBUG',
        },
    },
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Already default in many setups
...
# JWT settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=36500),  # Set to effectively infinite (100 years)
